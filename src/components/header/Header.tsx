...
// import { FruitStandLogo } from "../../icons";
...
//   const alerts: AlertProps[] = inventory
//     .filter(
//       (item) =>
...
//         title: isExpired ? "Expired Item" : "Low Stock Alert",
//         message: isExpired
//           ? `${item.productName} has expired in ${
//               item.warehouseLocation || "the warehouse"
//             }.`
//           : `${item.productName} is below restock threshold.`,
//         showLink: true,
//         linkHref: `/inventory/${item.id}`,
//         linkText: isExpired ? "Review spoilage" : "Restock now",
//       };
//     });
//   useEffect(() => {
//     console.log("alerts in Header", alerts);
//   }, [alerts]);

//   console.log("alerts inside NotificationDropdown", alerts);
