...
import { ProductTypes } from "../../hooks/Products/useProducts";
import { useMutation, useQueryClient } from "@tanstack/react-query";
import { updateProductsMutation } from "../../lib/api";
import { toast } from "sonner";
import FruitsForm from "./FruitsForm";

type FruitsEditModalProps = {
  item: ProductTypes;
  onClose: () => void;
};

const FruitsEditModal = ({ item, onClose }: FruitsEditModalProps) => {
  const queryClient = useQueryClient();
  const mutation = useMutation({
    mutationFn: updateProductsMutation,
    onSuccess: () => {
...
export default FruitsEditModal;
